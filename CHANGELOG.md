...
### Added
- Bot API 6.1 (@incrediboy, @yeticoder)
...
### Fixed
- Return correct data in `Entity::jsonSerialize` (@incrediboy)

## [0.76.1] - 2022-03-30
### Notes
- [:ledger: View file changes][0.76.1]
### Fixed
- Fix Entity serialising for Keyboards (@incrediboy) (#1304)

## [0.76.0] - 2022-03-20
### Notes
- [:ledger: View file changes][0.76.0]
### Added
- Bot API 5.6 (@incrediboy) (#1275)
- Bot API 5.7 (@incrediboy) (#1284)
- PSR3 (psr/log) version 2 and 3 compatible (@yeti) (#1287)
- Entity implements and uses JsonSerializable now (@incrediboy)
- Test with PHP 8.1 on Travis CI (@osavchenko) (#1291)
### Changed
- Bugfix: Fixed condition in \Longman\TelegramBot\Entities\Chat::isGroupChat() that previously also counted super groups and channels. (@incrediboy)

## [0.75.0] - 2021-12-29
### Notes
- [:ledger: View file changes][0.75.0] ∙ [:page_with_curl: DB migration script][0.75.0-sql-migration]
### Added
- Ability to directly set commands paths. (@wright-tw, @yeti) (#1252)
- Bot API 5.4. (@incrediboy, @yeti) (#1266)
- Bot API 5.5. (@incrediboy, @yeti) (#1267)
- The field `message_auto_delete_time` was added to the Chat Entity (@incrediboy) (#1265)
### Removed
- [:exclamation:][0.75.0-bc-removed-chatactions] Removed deprecated `ChatAction::` `RECORD_AUDIO` and `UPLOAD_AUDIO`. Use `RECORD_VOICE` and `UPLOAD_VOICE` instead. (@incrediboy) (#1267)
### Fixed
...
### Added
- [:exclamation:][0.74.0-bc-chatmember-subentities] Bot API 5.3 (Personalized Commands, Keyboard Placeholders). (@incrediboy, @yeti) (#1229, #1231)

## [0.73.1] - 2021-06-20
### Notes
- [:ledger: View file changes][0.73.1]
### Fixed
- Allow new optional parameters when setting and deleting webhook. (@incrediboy) (#1226)
...
### Added
- Bot API 5.1 (ChatMember Update types, Improved Invite Links, Voice Chat). (@massadm, @yeti) (#1199)
- Method to allow adding command classes directly. (@alligator77, @yeti) (#1207, #1209)
### Deprecated
